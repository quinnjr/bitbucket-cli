...
@Component({
  selector: 'app-workspace-command',
  standalone: true,
    ...
    <div class="max-w-4xl mx-auto px-6 py-12">
      ...
      <div class="mb-12">
        <nav class="flex items-center gap-2 text-sm text-[var(--color-neutral-400)] mb-4">
          ...
          <span class="text-[var(--color-neutral-700)]">workspace</span>
        </nav>
        <div class="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 class="text-3xl font-bold text-[var(--color-neutral-900)]">bitbucket workspace</h1>
            <p class="text-[var(--color-neutral-400)]">Manage workspaces</p>
          </div>
        </div>
      </div>
