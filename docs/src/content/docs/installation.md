...
Prebuilt binaries for Linux (x86_64 / arm64), macOS (Intel / Apple Silicon), and Windows are attached to every [GitHub release](https://github.com/pegasusheavy/bitbucket-cli/releases).
